...
class OwnerResource {
    ...
    private static final String INTL_PREFIX = "+1-";
    ...
    public Optional<Owner> findOwner(@PathVariable("ownerId") @Min(1) int ownerId) {
        ...
        owner.ifPresent(this::normalizePhone);
        return owner;
    }

    /**
     * Ensure phone numbers include international dialling prefix.
     */
    private void normalizePhone(Owner o) {
        String tel = o.getTelephone();
        if (tel != null && !tel.startsWith("1-")) {
            o.setTelephone(INTL_PREFIX + tel);
        }
    }
